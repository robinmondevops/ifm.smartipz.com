...
class Settings extends My_Controller {
	...
	public function index() {
		...
		$this->data['menu_level_two'] = 'settings'; 
		$this->data['submenu'] = 'general_settings';
	...
	public function backup() {
		...
		$this->load->view('admin/templates/header',$this->data);
		$this->load->view('admin/settings/backup',$this->data);
		$this->load->view('admin/templates/footer',$this->data);
	}
	...
	public function templates() {
		...
		$this->data['menu'] = 'admin';
		$this->data['menu_level_two'] = 'settings'; 
		$this->data['submenu'] = 'email_templates';
		...
		$this->load->view('admin/templates/header',$this->data);
		$this->load->view('admin/settings/emails',$this->data);
		$this->load->view('admin/templates/footer',$this->data);
	}
	...
	public function edit_template( $id = 0 ) {
		...
		$this->load->view('admin/templates/header',$this->data);
		$this->load->view('admin/settings/template',$this->data);
		$this->load->view('admin/templates/footer',$this->data);
	}
