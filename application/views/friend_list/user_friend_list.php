                                ...
                                <div class="profile_pics col-md-12">
                                    ...
                                    <div class="col-md-6" id="request_<?php echo $friend->friend_id; ?>">  
                                        ...
                                        <div class="row">  
                                            ...
                                            <?php /*<button id="<?php echo $friend->friend_id; ?>" data-action="<?php echo $action; ?>" data-friend="<?php echo $friend->friend_id; ?>" <?php echo ($action == '' || $action == '' )?'disabled':''; ?> data-id="<?php echo $this->user->id; ?>" class="btn btn-circle green btn-sm <?php echo $action; ?>" type="button"><?php echo $label; ?></button>*/?>
