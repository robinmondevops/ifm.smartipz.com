    ...
    <div class="page-content">
        <div class="container">
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light portlet-fit col-md-9">
                               ...
                               <?php /* <div class="profile-sidebar">
                                    ...
                                    <div class="portlet light profile-sidebar-portlet ">
                                        ...
                                        <div class="profile-userpic">
                                            ...
                                            <img src="<?php echo base_url('files/profile/'.$row['id'].'/'.$row['image']);?>" class="img-responsive avatar-edit-img" alt="" >
                                            <?php } else { ?>
                                                <img src="<?php echo base_url('assets/global/img/noimage.png');?>" class="img-responsive avatar-edit-img" >
                                            <?php } ?> 
                                        </div>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form role="form" class="" method="post" enctype="multipart/form-data">    
                                                            <div class="form-group <?php echo form_error('email')?'has-error':'';?>">
                                                                ...
                                                                <input readonly type="text" name="email" placeholder="Email" id="email" class="form-control" value="<?php echo $row['email'];?>"> 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="cropimage" method="post" enctype="multipart/form-data" action="<?php echo site_url('users/crop'); ?>">
