        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group <?php echo form_error('first_name')?'has-error':'';?>">
                    ...
                    <input class="form-control" name="first_name" placeholder="First Name" type="text" value="<?php echo $row['first_name'];?>">
            ...
            <div class="col-md-6">
                <div class="form-group <?php echo form_error('last_name')?'has-error':'';?>">
                    ...
                    <input class="form-control" name="last_name" placeholder="Last Name" type="text" value="<?php echo $row['last_name'];?>">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group <?php echo form_error('phone')?'has-error':'';?>">
                    ...
                    <input class="form-control" name="phone" placeholder="Phone" type="text" value="<?php echo $row['phone'];?>">
