...
<div class="col-md-12 reg_pop" >
    ...
    <form role="form" id="form_occ" class="form-horizontal" enctype="multipart/form-data" method="post" >
        ...
        <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered">
                            ...
                            <?php foreach($arr_occ as $category_name =>$arr_list ){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <input <?php echo in_array($list->id, $arr_per_occ_id )?'checked':''; ?>
            ...
            <div class="form-actions">
                ...
                <button id="save_occ" class="btn btn-success btn-block uppercase pull-right">Save Changes</button>
